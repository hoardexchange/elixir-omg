...
defmodule OMG.Eth.DevMiningHelper do
    ...
    defp create_spamming_account do
      spamming_acc = TestHelper.generate_entity()
      account_priv_enc = Base.encode16(spamming_acc.priv)
      passphrase = "dev.pariod"
